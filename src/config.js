...
export const ROLE_CONFIG = {
  publisher: {
    ...
    nav: [
      ...
      { id: "analytics", label: "Analytics", arabic: "التحليلات", icon: "chart", group: "Monetization" },
      { id: "earnings", label: "Earnings", arabic: "الأرباح", icon: "trend", group: "Finance" },
      { id: "withdrawals", label: "Withdrawals", arabic: "السحوبات", icon: "arrow-up", group: "Finance" },
      { id: "transactions", label: "Transactions", arabic: "المعاملات", icon: "receipt", group: "Finance" },
  ...
  advertiser: {
    ...
    nav: [
      { id: "overview", label: "Overview", arabic: "نظرة عامة", icon: "grid" },
      { id: "campaigns", label: "Campaigns", arabic: "الحملات", icon: "megaphone", group: "Advertising" },
      { id: "create-campaign", label: "Create Campaign", arabic: "إنشاء حملة", icon: "plus", group: "Advertising" },
      { id: "analytics", label: "Analytics", arabic: "التحليلات", icon: "chart", group: "Advertising" },
      { id: "reports", label: "Reports", arabic: "التقارير", icon: "file", group: "Advertising" },
      { id: "deposits", label: "Deposits", arabic: "الإيداعات", icon: "plus", group: "Finance" },
      { id: "balance", label: "Balance", arabic: "الرصيد", icon: "wallet", group: "Finance" },
      { id: "transactions", label: "Transactions", arabic: "المعاملات", icon: "receipt", group: "Finance" },
      { id: "billing", label: "Billing", arabic: "الفوترة", icon: "card", group: "Finance" },
      { id: "profile", label: "Profile", arabic: "الملف الشخصي", icon: "user", group: "Account" },
      { id: "settings", label: "Settings", arabic: "الإعدادات", icon: "settings", group: "Account" },
    ],
    metrics: [
