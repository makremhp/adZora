...
function PublisherAnalyticsPage({ data, onNavigate }) {
  ...
  const activitySites = websiteAnalytics.length ? websiteAnalytics : [{ name: "My Website" }, { name: "Store Website" }, { name: "Blog Website" }];
